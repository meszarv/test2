...
export default function SnapshotTabs({ snapshots, currentIndex, onSelect, onAdd, onChangeDate }) {
      ...
      {editIndex !== null && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4">
          <div className="bg-zinc-900 rounded-xl p-4 w-full max-w-sm space-y-3">
            ...
            <TextInput label="Month" type="month" value={editValue} onChange={setEditValue} />
